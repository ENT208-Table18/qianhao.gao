  ...
  <view class="page">
    ...
    <view class="auth-card">
      ...
      <view class="header">
        ...
        <text class="title">Travel Tycoon</text>
        <text class="subtitle">Track your footprints and light up the map</text>
      </view>
      ...
      <view class="tab-list">
        ...
        >
          <text class="tab-text">Login</text>
        </view>
        <view 
          class="tab" 
        ...
        >
          <text class="tab-text">Register</text>
        </view>
      </view>
      ...
      <view class="form">
        ...
        <!-- Forgot Password -->
        <text class="forgot-link" @click="onForgot">Forgot Password?</text>
      </view>
      ...
      <view class="divider">
        ...
        <view class="divider-text-wrap">
          <text class="divider-text">Or sign in with social account</text>
        </view>
        <view class="divider-line"></view>
      </view>
...
import { setCurrentAccountId } from '../../utils/account-session'
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.loading = true
      setTimeout(() => {
        setCurrentAccountId(email)
        this.loading = false
        uni.showToast({
          title: this.mode === 'login' ? 'Login successful' : 'Registration successful',
          icon: 'success',
        })
        setTimeout(() => {
    ...
    onForgot() {
      uni.showToast({ title: 'Forgot-password flow can be integrated', icon: 'none' })
    },
    onSocialLogin(platform) {
      uni.showToast({ title: `${platform} login demo`, icon: 'none' })
    },
  },
}
</script>
