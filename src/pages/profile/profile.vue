    ...
    <scroll-view class="scroll" scroll-y>
      ...
      <view class="hero-card">
          ...
          <view class="hero-left">
            ...
            <view class="hero-texts">
              ...
              <view class="level-pill">
                ...
                <text class="level-text">Level {{ level }}</text>
              </view>
            </view>
          </view>
        ...
        <view class="progress-block">
          <view class="progress-row">
            <text class="progress-label">Upgrade Progress</text>
        ...
        <view class="stats-row">
          <view class="stat-col">
            ...
            <text class="stat-cap">Travel Coins</text>
          </view>
          <view class="stat-col">
            <view class="stat-top">
            ...
            <text class="stat-cap">Footprints</text>
          </view>
          <view class="stat-col">
            <view class="stat-top">
            ...
            <text class="stat-cap">Photos</text>
          </view>
        </view>
      </view>
      ...
      <view class="section">
        <view class="section-title">
          ...
          <text class="section-title-text">My Achievements</text>
        </view>
        <view class="ach-grid">
          <view
          ...
          >
            ...
            <view v-if="item.unlocked" class="ach-badge">
              <text class="ach-badge-text">Unlocked</text>
            </view>
      ...
      <view class="section">
        <view class="section-title">
          ...
          <text class="section-title-text">Recent Activity</text>
        </view>
...
<script>
import { getCityProgress, TOTAL_CITY_COUNT } from '../../utils/city-progress'
import { getTravelCoins } from '../../utils/travel-coins'
...
export default {
  data() {
    return {
      ...
      travelCoins: 0,
      footprintCurrent: 2,
      footprintTotal: TOTAL_CITY_COUNT,
      photoCount: 12,
      assets: ASSETS,
      achievements: [
        { id: '1', emoji: '🎯', title: 'First Check-in', unlocked: true },
        { id: '2', emoji: '🌏', title: 'Travel Across China', unlocked: false, progress: '3/10' },
        { id: '3', emoji: '📷', title: 'Photo Master', unlocked: true },
        { id: '4', emoji: '💬', title: 'Social Pro', unlocked: false, progress: '5/20' },
        { id: '5', emoji: '🏠', title: 'AR Explorer', unlocked: true },
        { id: '6', emoji: '💰', title: 'Wealth Freedom', unlocked: false, progress: '370/1000' },
      ],
      activities: [
        {
          id: 'a1',
          title: 'Check-in · Guangdong',
          date: '2026-03-25',
          reward: '+120',
          iconBg: '#dbeafe',
  ...
  methods: {
    ...
    syncFootprintProgress() {
      const { litCount, totalCount } = getCityProgress()
      this.footprintCurrent = litCount
      this.footprintTotal = totalCount
    },
    onSettings() {
      uni.showToast({ title: 'Settings', icon: 'none' })
    },
    onTabClick(tab) {
